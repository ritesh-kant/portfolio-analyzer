...
*N/A — defensive filter integrated into all live strategies by default.*
*No hold-out evaluation required.  Filter stays active unless Sortino impact*
*is negative by more than 0.10 on 3 consecutive live strategy evaluations.*

---

*Registered: 2026-05-22 by Ritesh Kant.  Filter parameters (§4) are
pre-registered and immutable.  Changes to exclusion window or thresholds
after any live deployment are process violations (plan §3.3).*
