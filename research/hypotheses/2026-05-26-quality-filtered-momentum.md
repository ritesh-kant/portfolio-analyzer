...
companies whose business is getting *worse*. Then, each month within that filtered
...
anti-strategy check because in a bull market, even the *worst* stocks went up — the
...
- Universe percentile thresholds (10% / 20% of *filtered* universe)
- Vol-target level (15%)
...
*Registered: 2026-05-26.*
*Signal construction (§3) and falsification criteria (§4) are pre-registered and immutable.*
*Strategy Q — 17 prior experiments; DSR gate raised to 0.65.*
